...
> État actuel : **Sprint 0 — fondations du projet**. La fenêtre native et le cœur technique sont en place ; la connexion réelle arrivera au Sprint 1.
...
Les choix structurants sont détaillés dans [l’ADR de la stack](docs/adr/0001-technical-stack.md), et l’état du Sprint 0 dans [docs/sprint-0.md](docs/sprint-0.md).
