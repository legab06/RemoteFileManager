...
> État actuel : **Sprint 3 — transferts SFTP, version 0.4.0**. L’implémentation et
> les tests automatisés sont terminés ; la validation avec un serveur réel reste
> à effectuer.
...
Les choix structurants sont détaillés dans [l’ADR de la stack](docs/adr/0001-technical-stack.md), et les livrables courants dans [docs/sprint-3.md](docs/sprint-3.md).
